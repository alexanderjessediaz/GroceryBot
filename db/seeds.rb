...
Teaspoon.create(measurement:)
Tablespoon.create(measurement:)
Cup.create(measurement:)
Pound.create(measurement: 1.0)
Ounce.create(measurement:)

#ground beef taco salad

#measurements
1tsp = Teaspoon.create(measurement:1.0) 
...
1cup = Cup.create(measurement:1.0)
2Tbsp = Tablespoon.create(measurement:2.0)
2cup = Cup.create(measurement:2.0)
...
ingredients: "1 cup wild rice rinsed;
½ teaspoon fine sea salt divided;
1 ½ pounds sweet potatoes 2 medium or 3 small peeled and sliced into 1” cubes;
1 ½ tablespoons extra-virgin olive oil;
¾ cup raw pepitas green pumpkin seeds; sunflower seeds; chopped pecans or almonds;
